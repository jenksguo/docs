...
Set up a Xero application in the [Xero developer portal](https://developer.xero.com/myapps/). Xero will generate a **Client ID** and **Client Secret** for your application.
